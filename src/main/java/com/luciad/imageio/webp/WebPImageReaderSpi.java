...
public class WebPImageReaderSpi extends ImageReaderSpi {
   ...
   public WebPImageReaderSpi() {
      super("Luciad", "1.0", new String[] { "WebP", "webp" }, new String[] { "webp" },
            new String[] { "image/webp" }, WebPReader.class.getName(),
            new Class[] { ImageInputStream.class }, new String[] { WebPImageWriterSpi.class
   ...
   public boolean canDecodeInput(final Object source) throws IOException {
      ...
      final ByteOrder oldByteOrder = stream.getByteOrder();
      stream.mark();
      ...
      try {
         ...
         final long chunkLength = stream.readUnsignedInt();
         final long streamLength = stream.length();
